# INFORME DE RENDIMIENTO DEL EQUIPO DE DEV – SPRINT X
...
- **Total de tareas asignadas:** [Número Total]  
- **Total de tareas completadas:** [Número Total]  
- **Porcentaje de finalización del sprint:** [(tareas completadas / tareas asignadas) * 100]%  
- **User Stories completadas:** [Cantidad]  
- **Story Points completados:** [Cantidad]  
- **Bugs resueltos:** [Cantidad]  

## 2. Desempeño Individual

| Dev   | Tareas Completadas | Story Points | Daily Meetings Asistidos | Bugs Resueltos | Monedas Ganadas | Monedas Gastadas | Diamantes Ganados |
|-------|---------------------|--------------|---------------------------|----------------|------------------|-------------------|--------------------|
| DEV 1 |                     |              |                           |                |                  |                   |                    |
| DEV 2 |                     |              |                           |                |                  |                   |                    |
...
- **Acciones tomadas para resolver problemas:** [Explicación de soluciones aplicadas]  
...
- **Plan para mejorar la eficiencia:** [Propuestas concret
